...
EPAair_O3_PM25_NC1819_Processed <- merge(Combined.AQ.Data.processed, 
                                           daily.means)
 #9

mutate(EPAair_O3_PM25_NC1819_Processed, ozone = meanAQI)

#10
nrows(EPAair_O3_PM25_NC1819_Processed)
ncols(EPAair_O3_PM25_NC1819_Processed)

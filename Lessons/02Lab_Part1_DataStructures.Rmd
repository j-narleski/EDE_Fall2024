...
vector2 <- c("one","two","three") # Vector type: Characters
vector2
...
# Multiplies values in vector1 & vector4
vector1 * vector4

# Multiply each value in vector1 by 10
vector1 * 10

# Returns vector2 characters in all-caps
toupper(vector2) 

# Returns the opposite boolean for each in vector3
!vector3
...
```{r Creating Matrices}
# Matrices ----
matrix1 <- matrix(1:20, nrow = 5,ncol = 4) # Filling matrix by column
matrix1
#matrix1 has 5 rows and 4 columns

matrix2 <- matrix(1:20, nrow = 5, ncol = 4, byrow = TRUE) # Filling matrix by row
matrix2
...
matrix1[4, 1] # Return value from row 4 column 1 from matrix 1

matrix1[4,  ] # Return values from row 4 from matrix 1

matrix1[ , 3] # Return values from column 3 from matrix 1 

matrix1[c(12, 14)] # Return values 12 and 14

matrix1[c(12:14)] # Return values from 12 to 14
...
matrix4 <- matrix(
  ...
  dimnames = list(
    rnames, 
    cnames)
  ) # names rows and columns of matrix 4
...
# Returns the object age
list1$age

# Returns all the names of the objects in list1
names(list1)

# Returns 1st and 2nd objects of list1
list1[1:2]

# Changes name in list1 to Janelle
list1$name = "Janelle"
list1$name

# Accesses 4th element of list to change it (age)
list1[[4]] = 44
list1
```
...
f <- c(TRUE, TRUE, TRUE, FALSE) # What type of vector? Logicals

#Combine the vectors into a dataframe
dataframe1 <- data.frame(d,e,f) 

#Set the column names & View
names(dataframe1) <- c("ID","Color","Passed"); View(dataframe1) #See dataframe 

...
>Answer: It's important to know what is in your dataset, how it's organized, and what data might be missing. This can help with future data collection and direct how it should be organized.
...
> Answer: It depends on the type of data you want to display! If you're looking at the count of something a bar plot may be beneficial, or if you're looking at mean/median a box-and-whisker would be better!

## Ending discussion
What did you learn about the USGS discharge dataset today? What separate insights did the different graph types offer?
> Answer: These different graphs offered insights about the relationships between the average discharge and gage height.


How can multiple options for data exploration inform our understanding of our data?

> Answer: Mulitple options for data exploration allow for different manipulations of data that can display different trends that we aren't able to see by just looking at the numbers.
...
> Answer: The main pattern I saw was that the average discharge increased with the gage height of the Eno River. This makes sense as the higher the water height, the more likely to be displaced.

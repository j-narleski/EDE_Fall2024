...
Lancaster_plot <- ggplot() +
  ...
  geom_sf(data = Lancaster_utm, color = "darkblue", fill = "lightyellow2") +
  geom_sf(data = Lancaster_gagesites, aes(color = "site_no"))+
  geom_sf(data = Lancaster_gagesites_15, aes(color = "station_nm.x")) +
  scale_color_manual(values = c("site_no" = "blue", 
                              "station_nm.x" = "seagreen"))
